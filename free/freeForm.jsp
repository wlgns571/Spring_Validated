		...
		<form:form action="freeRegist.wow" method="post"
			...
			<table class="table table-striped table-bordered">
				...
				<tr>
					...
					<%-- <input type="text" name="boWriter" value="${freeBoard.boWriter }"> --%>
					<form:errors path="boWriter"></form:errors>
<!-- 					<input type="text" name="boWriter" value="" -->
<!-- 						class="form-control input-sm" required="required"> -->
					</td>
				</tr>
				<tr>
...
<!-- 					<input type="password" name="boPass" value="" -->
<!-- 						class="form-control input-sm" required="required" pattern="\w{4,}" -->
<!-- 						title="알파벳과 숫자로 4글자 이상 입력">  -->
						<span class="text-danger">
							<span class="glyphicon glyphicon-exclamation-sign"
							aria-hidden="true"></span> 수정 또는 삭제시에 필요합니다.
					</span></td>
				</tr>
				<tr>
					<th>분류</th>
