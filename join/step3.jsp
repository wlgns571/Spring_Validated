...
<body>
	...
	<div class="container">
		<form:form action="regist.wow" method="post" modelAttribute="member">
			<div class="row col-md-8 col-md-offset-2">
				...
				<table class="table">
					...
					<tr class="form-group-sm">
						<th>생일</th>
						<td>
							<input type="date" value="${member.memBir }" name="memBir" class="form-control input-sm">
					...
					<tr>
						<td colspan="2">
							<div class="pull-left">
								<a href="${pageContext.request.contextPath}/join/cancel.wow"
